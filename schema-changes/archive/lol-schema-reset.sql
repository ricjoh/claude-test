...
-- DELETE from DeliveryDetailReceipt WHERE CreateDate > '2022-10-27 17:00:00.000000'
DELETE from DeliveryDetail WHERE EDIDocId in ( select DocId from EDIDocument where EDIKey = 'LOL' ); 
DELETE from Delivery WHERE CreateDate > '2022-10-27 17:00:00.000000';
 
DELETE from OfferItemVat WHERE CreateDate > '2022-10-27 17:00:00.000000';
DELETE from OfferItem WHERE CreateDate > '2022-10-27 17:00:00.000000';
DELETE from Offer WHERE CreateDate > '2022-10-27 17:00:00.000000';

DELETE from BillOfLading WHERE CreateDate > '2022-10-27 17:00:00.000000';
...
-- SELECT * from Vat WHERE CreateDate > '2022-10-27 17:00:00.000000';
